...
class MonodepthOptions:
    def __init__(self):
        ...
        #                          default=os.path.join(file_dir, "data/kitti"))
        self.parser.add_argument("--data_path",
                                 type=str,
                                 help="path to the training data",
                                 default=os.path.join(file_dir, "eigen"))
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default=os.path.join(file_dir, "logs/tmp"))

        # TRAINING options
        self.parser.add_argument("--att",
                                 type=str,
                                 default=None, choices=[None, 'CBAM', 'BAM', 'scSE', 'simam', 'TA', 'CA'])
        self.parser.add_argument("--use_frelu",
                                 type=bool,
                                 default=True)
        self.parser.add_argument("--use_aspp",
                                 type=bool,
                                 default=True)
        ...
        self.parser.add_argument("--model_name",
                                 ...
                                 default="mono+stereo_model_640x192")
        ...
        self.parser.add_argument("--weights_init",
                                 ...
                                 default="weights/resnet18-pytorch")
        ...
        self.parser.add_argument("--load_weights_folder",
                                 ...
                                 default='./fj_best_640x192/models/weights_19/')
